class User < ActiveRecord::Base
  ...
  ## check the next 3 out #
   # Sends activation email.
  def send_activation_email
    UserMailer.account_activation(self).deliver   #_now  only works on later versions of Rails 4.2beta
  end
  ...
  def send_password_reset_email
    UserMailer.password_reset(self).deliver    #_now  as above
  end
  ...
  # Sends activation email.
  def send_activation_email
    UserMailer.account_activation(self).deliver   #_now  later version
  end
